...
cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/ddns.config feeds/packages/net/ddns-scripts/files/
cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/etc/banner package/base-files/files/etc/
cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/etc/mtd-rw package/base-files/files/etc/init.d/
chmod 0755 package/base-files/files/etc/init.d/mtd-rw
cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/default-settings/zzz-default-settings package/lean/default-settings/files/
cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/default-settings/Makefile package/lean/default-settings/
#cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/autocore/index.htm package/lean/autocore/files/arm/
cp $GITHUB_WORKSPACE/lean/Redmi-AX6S/data/zones.lua feeds/luci/applications/luci-app-firewall/luasrc/model/cbi/firewall/
